...
public class SharingController {
    ...
    @GetMapping("/sharing/account")
    public ResponseEntity<ResultListResponse> findMemberAccountByEmail() {
    ...
    public ResponseEntity<SharingDto> saveSharing(
        ...
        return ResponseEntity.ok()
                .body(sharingService.save(
                        sharingRequestDto.getToMemberEmail(),
    ...
    public ResponseEntity<SharingResponseDto> deleteSharing(
            @PathVariable("sharingid") Long id
    ) {
        sharingService.cancelInvite(id);
        return ResponseEntity.ok()
